    ...
    <main className="min-h-screen bg-kid-base font-body flex flex-col">
      <nav className="bg-white/80 backdrop-blur-lg">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Link href="/login" className="font-body font-extrabold text-[13px] text-kid-violet hover:underline">
            Já tenho conta →
          </Link>
        </div>
      </nav>
      ...
      <section className="flex-1 flex items-center justify-center px-5 py-10">
        <div className="w-full max-w-[440px]">
          <div className="text-center mb-8">
            <span className="kid-chip kid-chip-gold inline-flex items-center gap-1">
              <AppIcon name="bolt" size={14} /> COMEÇAR GRÁTIS
            </span>
            ...
            <p className="font-body text-[15px] text-kid-text-soft mt-2">
              Cadastre sua família em menos de 1 minuto.
            </p>
          </div>
          ...
          <form action="/pai" className="bg-white rounded-kid-xl p-6 space-y-4">
            ...
            <label className="flex items-start gap-2 font-body font-bold text-[13px] text-kid-text-body cursor-pointer">
              <input type="checkbox" name="terms" required className="w-4 h-4 mt-0.5 accent-kid-violet" />
              <span>
                Concordo com os{" "}
                <Link href="/termos" className="text-kid-violet font-extrabold hover:underline">
                  termos de uso
                </Link>{" "}
                e{" "}
                <Link href="/privacidade" className="text-kid-violet font-extrabold hover:underline">
                  política de privacidade
                </Link>
                . Sou responsável legal pela(s) criança(s) cadastrada(s) (LGPD).
              </span>
            </label>
          ...
          <p className="text-center mt-6 font-body text-[14px] text-kid-text-body">
            Já tem conta?{" "}
            <Link href="/login" className="font-extrabold text-kid-violet hover:underline">
              Entrar
            </Link>
          </p>
        </div>
