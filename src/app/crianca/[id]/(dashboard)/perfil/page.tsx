...
export default async function Perfil({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-[480px] mx-auto lg:max-w-5xl">
      <section className={`relative h-[360px] lg:h-[300px] lg:rounded-kid-xl lg:mt-8 lg:overflow-hidden ${heroBg}`}>
        <Image
          src={heroSrc}
      ...
      <div className="px-5 pt-5 space-y-6 bg-kid-base lg:px-8">
        <div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-6 lg:items-start space-y-6 lg:space-y-0">
          ...
          {family_children.length > 0 && (
            <section>
              ...
              <div className="-mx-5 px-5 lg:mx-0 lg:px-0 overflow-x-auto scrollbar-hide">
